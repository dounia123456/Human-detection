...
# top label
start1 = tk.Label(text = "REAL-TIME-HUMAN\nDETECTION  &  COUNTING", font=("Arial", 50,), fg="blue") # same way bg
...
Button(window, text="▶ START",command=start_fun,font=("Arial", 25),  fg = "Black", cursor="hand2", borderwidth=3, relief="raised").place(x =130 , y =570 )
...
# exit button created
Button(window, text="❌ EXIT",command=exit_win,font=("Arial", 25), fg = "black", cursor="hand2", borderwidth=3, relief="raised").place(x =680 , y = 570 )
...
if exit1==False:
    ...
    def image_option():
        ...
        def detectByPathImage(path):
            ...
            # function defined to plot the enumeration for people detected
            ...
            Button(windowi, text="Enumeration\nPlot", command=img_enumeration_plot, cursor="hand2", font=("Arial", 20), fg="blue").place(x=100, y=530)
            Button(windowi, text="Avg. Accuracy\nPlot", command=img_accuracy_plot, cursor="hand2", font=("Arial", 20), fg="blue").place(x=700, y=530)
        ...
        Button(windowi, text="PREVIEW",command=prev_img, cursor="hand2", font=("Arial", 20), bg = "yellow", fg = "black").place(x = 410, y = 350)
        Button(windowi, text="DETECT",command=det_img, cursor="hand2", font=("Arial", 20), bg = "orange", fg = "black").place(x = 620, y = 350)
    ...
    def video_option():
        ...
        def detectByPathVideo(path, writer):
            ...
            Button(windowv, text="Enumeration\nPlot", command=vid_enumeration_plot, cursor="hand2", font=("Arial", 20), fg="blue").place(x=100, y=530)
            Button(windowv, text="Avg. Accuracy\nPlot", command=vid_accuracy_plot, cursor="hand2", font=("Arial", 20), fg="blue").place(x=700, y=530)
        ...
        Button(windowv, text="DETECT", command=det_vid, cursor="hand2", font=("Arial", 20),  fg="blue").place(x=620, y=350)
    ...
    def camera_option():
        ...
        def detectByCamera(writer):
            ...
            Button(windowc, text="Enumeration\nPlot", command=cam_enumeration_plot, cursor="hand2", font=("Arial", 20), fg="blue").place(x=100, y=530)
            Button(windowc, text="Avg. Accuracy\nPlot", command=cam_accuracy_plot, cursor="hand2", font=("Arial", 20), fg="blue").place(x=700, y=530)
    ...
    Button(window1, text="DETECT  FROM   IMAGE ➡",command=image_option, cursor="hand2", font=("Arial",30), bg = "light green", fg = "black").place(x = 350, y = 150)
    ...
    Button(window1, text="DETECT FROM CAMERA ➡",command=camera_option, cursor="hand2", font=("Arial", 30), bg = "light green", fg = "black").place(x = 350, y = 450)
    ...
    # created exit button
    Button(window1, text="❌ EXIT",command=exit_win1,  cursor="hand2", font=("Arial", 25), bg = "red", fg = "black").place(x = 440, y = 600)
